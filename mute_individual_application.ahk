...
; Modified version of 'mute-current-application', by kristoffer-tvera
...
Application = spotify.exe  ; change this to whichever application you want to close. This will be the exe file you want to mute.

F1::  ; F1 key used as the mute trigger. See below
      ; This can be changed to any key/combination. Keep the following in mind
      ; Alt = '!'
      ; Control = '^'
      ; Shift = '+'
